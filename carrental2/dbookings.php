        ...
        <div class="card-body">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    foreach(findall("bookings", "driver_id='$did'") as $b) { 
                        extract($b);
                        $title=single("variants","cid='$variant_id'")["title"];
                        $price=single("variants","cid='$variant_id'")["price"]; 
                        $username=single("bookings","driver_id='$did'")["customer_id"];
                        $usercontact=single("customers","userid='$username'")["phone"];                       
                        ?>
                        <tr>
                            <td><?= $bid ?></td>
                            <td><?= $title ?></td>
                            ...
                            <td>
                                ...
                                { ?>
                                <a href="bkdetails.php?bid=<?= $bid ?>" class="btn btn-outline-primary btn-sm">Details</a>
                               <?php  } ?>
                            </td>
                        </tr>
                    <?php } ?>
